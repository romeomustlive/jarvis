...
export function UpdateExerciseForm(props: UpdateExerciseFormProps) {
  const [actionState, action, isPending] = useActionState(
    updateExercise.bind(null, props.exercise.id),
    {
      message: '',
    },
  )
    ...
    <Form action={action} actionState={actionState}>
      <FormField>
        ...
        <Input
          ...
          name="name"
          defaultValue={
            (actionState.payload?.get('name') as string) ?? props.exercise.name
          }
        />
